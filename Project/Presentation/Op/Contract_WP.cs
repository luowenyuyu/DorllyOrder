                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            bc.invalid();
                            collection.Add(new JsonStringValue("status", bc.Entity.ContractStatus)); collection.Add(new JsonStringValue("status", bc.Entity.ContractStatus));
                            try
                            {
                                obj.ExecuteNonQuery("update Mstr_WorkPlace set WPStatus='free' where WPNo in (select WPNo from Op_ContractWPRentalDetail where RefRP='" + bc.Entity.RowPointer + "')");
