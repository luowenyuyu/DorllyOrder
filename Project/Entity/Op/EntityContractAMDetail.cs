...
{
    /// <summary>合同电表记录</summary>
    /// <author>tianz</author>
    /// <date>2017-07-21</date>
    [System.Serializable]
    public class EntityContractAMDetail
    {
        ...
        private string _AMMeterNo;
        private decimal _AMStartReadout;
        private decimal _AMMeterRate;
        ...
        {
            get { return _AMMeterNo; }
            set { _AMMeterNo = value; }
        }

        /// <summary>
        /// 功能描述：起始读数
        /// </summary>
        public decimal AMStartReadout
        {
            get { return _AMStartReadout; }
            set { _AMStartReadout = value; }
        }

        /// <summary>
        /// 功能描述：倍率
        /// </summary>
        public decimal AMMeterRate
        {
            get { return _AMMeterRate; }
            set { _AMMeterRate = value; }
        }
