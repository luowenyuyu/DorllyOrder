<%@ Page Language="C#" AutoEventWireup="true" Inherits="project.Presentation.Op.Contract_WPPT,project" %>
...
<body>
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 合同管理 <span class="c-gray en">&gt;</span> 工位服务合同 <a class="btn btn-success radius r mr-20" style="line-height: 1.6em; margin-top: 2px" href="javascript:location.replace(location.href);" title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a></nav>
        ...
        <div id="bodyeditdiv4">
            <table class="tabedit">
                <tr>
                    ...
                    <td class="tdr1">
                        <input type="text" id="WPNo" class="input-text size-MINI" disabled="disabled" style="width: 75%" />
        ...
        function BandResuleData(temp) {
            ...
            if (vjson.type == "getwpno") {
                if (vjson.flag == "1") {
                    ...
                    $("#UnitPrice1").val(vjson.WPSeatPrice);
