<%@ Page Language="C#" AutoEventWireup="true" Inherits="project.Presentation.Op.GetOccupancyRate,project"  %>
<!DOCTYPE>
...
<body>
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 报表管理 <span class="c-gray en">&gt;</span> 出租率报表 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:2px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
   <div id="list" class="pt-5 pr-20 pb-5 pl-20">
	    <div class="cl pd-10  bk-gray mt-2"> 
             月份&nbsp;&nbsp;
            <input type="text" class="input-text size-MINI" id="MinMonth" value="<%=FirstMonth %>" style="width:110px" />
            &nbsp;&nbsp;到&nbsp;&nbsp;
            <input type="text" class="input-text size-MINI" id="MaxMonth" value="<%=ToMonth %>" style="width:110px" />
