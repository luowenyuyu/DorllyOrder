<%@ Page Language="C#" AutoEventWireup="true" Inherits="project.Presentation.Op.GetReceivableList,project"  %>
<!DOCTYPE>
...
<body>
    ...
    <div id="list" class="pt-5 pr-20 pb-5 pl-20">
	    <div class="cl pd-10  bk-gray mt-2"> 
            月份&nbsp;<input type="text" class="input-text size-MINI" id="Month" value="<%=GetDate().ToString("yyyy-MM") %>" style="width:110px" />
