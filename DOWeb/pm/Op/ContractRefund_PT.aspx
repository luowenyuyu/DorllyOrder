<%@ Page Language="C#" AutoEventWireup="true" Inherits="project.Presentation.Op.ContractRefund_PT,project"  %>
<!DOCTYPE>
...
<body>
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 退租管理 <span class="c-gray en">&gt;</span> 房屋物业合同退租 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:2px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
        ...
        <div id="bodyeditdiv4">        
            <table class="tabedit">
                ...
                <tr>
                    ...
                    <td class="tdr2"><input type="text" id="RMArea1" class="input-text size-MINI" /></td>
                    <td class="tdl2">单价(元/㎡/月)</td>
                    <td class="tdr2"><input type="text" id="UnitPrice1" class="input-text size-MINI" /></td>
                </tr>
                <tr>
                    <td class="tdl2">备注</td>
    ...
    <div id="refunddiv" style="display:none;">
        <table style="width:700px; margin-top:10px;">
            <tr>
                ...
                <td style="width:300px;"><input type="text" id="RefundDate" class="input-text size-MINI" disabled="disabled"/></td>
                <td style="width:100px; text-align:center; padding:10px;"">客户名称</td>
                <td style="width:300px;"><input type="text" id="ContractCustName1" class="input-text size-MINI" disabled="disabled"/></td>
            </tr>
            <tr>
                <td style="text-align:center; padding:10px;">合同编号</td>
                <td><input type="text" id="ContractNo1" disabled="disabled" class="input-text size-MINI" disabled="disabled"/></td>
                <td style="text-align:center; padding:10px;">手工合同编号</td>
                <td><input type="text" id="ContractNoManual1" class="input-text size-MINI" disabled="disabled"/></td>
            </tr>
            <tr>
                <td style="text-align:center; padding:10px;">合同签订日期</td>
                <td><input type="text" id="ContractSignedDate1" class="input-text size-MINI" disabled="disabled"/></td>
                <td style="text-align:center; padding:10px;">生效日期</td>
                <td><input type="text" id="ContractStartDate1" class="input-text size-MINI" disabled="disabled"/></td>
            </tr>
            <tr>
                <td style="text-align:center; padding:10px;">客户入场日期</td>
                <td><input type="text" id="EntryDate1"class="input-text size-MINI" disabled="disabled"/></td>
                <td style="text-align:center; padding:10px;">到期日期</td>
                <td><input type="text" id="ContractEndDate1" class="input-text size-MINI" disabled="disabled"/></td>
            </tr>
        </table>
        <div id="refundlist"></div>
        <div style="margin:15px 100px;">
            <input class="btn btn-primary radius" type="button" onclick="refundsubmit()" value="&nbsp;确定退租&nbsp;" />&nbsp;&nbsp;
            <input class="btn btn-primary radius" type="button" onclick="refundcancel()" value="&nbsp;取消退租&nbsp;" />
        </div>
    </div>
    ...
    <script type="text/javascript">
        function BandResuleData(temp) {
            ...
            if (vjson.type == "refund") {
                if (vjson.flag == "1") {
                    $("#RefundDate").val(vjson.RefundDate);
                    $("#ContractNo1").val(vjson.ContractNo);
                    $("#ContractCustName1").val(vjson.ContractCustName);
                    $("#ContractNoManual1").val(vjson.ContractNoManual);
                    $("#ContractSignedDate1").val(vjson.ContractSignedDate);
                    $("#ContractStartDate1").val(vjson.ContractStartDate);
                    $("#ContractEndDate1").val(vjson.ContractEndDate);
                    $("#EntryDate1").val(vjson.EntryDate);
                    $("#FeeStartDate1").val(vjson.FeeStartDate);

                    $("#refundlist").html(vjson.liststr);
        ...
        function refundsubmit() {
            ...
            submitData.RefundDate = $("#RefundDate").val();
            submitData.ContractNoS = $("#ContractNoS").val();
            submitData.ContractNoManualS = $("#ContractNoManualS").val();
            submitData.ContractTypeS = "04";
            submitData.ContractSPNoS = $("#ContractSPNoS").val();
        ...
        jQuery(function () {
            ...
            //var RefundDate = new JsInputDate("RefundDate");
