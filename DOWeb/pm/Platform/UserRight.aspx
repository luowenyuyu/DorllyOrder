...
<body>
    ...
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 系统管理 <span class="c-gray en">&gt;</span> 用户权限设置 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:2px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
                ...
                if (vjson.flag == "1") {
                    ...
                    $("input[name='chkmenu']").change(function () {
                        if ($("#" + this.id).prop('checked')) {
                            ...
                            $("#" + $("#parent" + this.id).val()).prop('checked', true);
                        }
                        else
        ...
        function submit() {
            ...
            $("input[name='chkmenu']").each(function () {
                ...
                if (menu.prop("checked")) {
                    jsonstr = jsonstr + menu[0].id + "@";
                    
                    var it = "";
                    $("input[name='" + menu[0].id + "']").each(function () {
                        var item = $(this);
