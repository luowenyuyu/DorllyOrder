...
<body>
    ...
    <div>
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 系统管理 <span class="c-gray en">&gt;</span> 用户角色 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:2px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    ...
    <div id="edit" class="pt-5 pr-20 pb-5 pl-20" style="display:none;">
      <div class="form form-horizontal" id="editlist">
        <div class="row cl">
          <label class="form-label col-2"><span class="c-red">*</span>用户角色编号：</label>
          <div class="formControls col-4">
            <input type="text" class="input-text required" placeholder="用户角色编号" id="UserTypeNo" data-valid="isNonEmpty||between:1-30" data-error="用户角色编号不能为空||用户角色编号长度为0-30位"/>
          </div>
          <div class="col-3"></div>
        </div>
        <div class="row cl">
          <label class="form-label col-2"><span class="c-red">*</span>用户角色名称：</label>
          <div class="formControls col-4">
            <input type="text" class="input-text required" placeholder="用户角色名称" id="UserTypeName" data-valid="isNonEmpty||between:1-50" data-error="用户角色编号不能为空||用户角色编号为0-50位"/>
          </div>
          <div class="col-3"></div>
        </div>
        <div class="row cl">
        ...
        function BandResuleData(temp) {
            ...
            if (vjson.type == "submit") {
                if (vjson.flag == "1") {
                    ...
                    showMsg("UserTypeNo", "用户角色在系统已存在", "1");
                }
                else {
                    layer.msg("数据操作出错！");
                }
