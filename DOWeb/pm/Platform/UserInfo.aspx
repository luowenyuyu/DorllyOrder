      ...
      <div class="form form-horizontal" id="editlist">
        <div class="row cl">
          ...
          <div class="formControls col-4">
            <input type="text" class="input-text required" placeholder="用户ID" id="UserNo" data-valid="isNonEmpty||between:2-16" data-error="用户ID不能为空||用户ID长度为2-16位" />
          </div>
            <div class="col-3"></div>
        </div>
        <div class="row cl">
          ...
          <div class="formControls col-4">
            <input type="text" class="input-text required" placeholder="用户姓名" id="UserName" data-valid="isNonEmpty||between:2-16" data-error="用户姓名不能为空||用户姓名长度为2-16位"/>
          </div>
          <div class="col-3"></div>
        </div>
        <div class="row cl">
